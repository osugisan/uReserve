                ...
                <div class="max-w-2xl mx-auto py-4">
                    ...
                    <form method="POST" action="{{ route('events.update', ['event' => $event->id]) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea id="information" class="block mt-1 w-full" name="information" required/>{{ $event->information }}
                        </div>

                        <div class="flex justify-between">
                            <div class="mt-4">
                                <x-jet-label for="event_date" value="イベント日付" />
                                <x-jet-input id="event_date" class="block mt-1 w-full" type="text" name="event_date" value="{{ $event->editEventDate }}" required/>
                            </div>
                        ...
                        <div class="md:flex justify-between items-end">
                            ...
                            <div class="flex space-x-4 justify-around items-center">
                                <input type="radio" name="is_visible" value="0" @if($event->is_visible === 1) checked @endif>表示
                                <input type="radio" name="is_visible" value="1" @if($event->is_visible === 0) checked @endif>非表示
                            </div>
